...
let questions = [
    {   
        //questão 0
        question: '1 - Em que projeto o Alan Kay trabalhou na década de 1970?',
        options: [
            'a) Dynabook',
            'b) Windows 98',
        ],
    ...
    {
        //questão 1
        question: '2 - Escolha a opção que descreve o nome e imagem que representa o Mascote da linguagem JAVA:',
        options: [
            'a',
            'b' 
        ],
